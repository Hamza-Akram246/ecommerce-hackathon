          ...
          <div className="flex-col ">
            <h6>
              <input
                ...
                className="border border-r-[#FF9F0D] p-4 border-r-[60px] md:mb-[40px] border-gray-300 h-[70px] md:w-[425px] md:ml-0 ml-3 w-[350px]"
              />
            </h6>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="font-normal text-[16px] leading-[24px] w-[205px] h-[47.7px]">
            ...
            <div className="w-full md:w-[423px] h-auto bg-white mb-[30px] border border-gray-300 p-4 mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 border border-gray-200 rounded-md">
                  Burger
                </span>
                <span className="px-3 py-1 border border-gray-200 rounded-md">
                  Pizza
