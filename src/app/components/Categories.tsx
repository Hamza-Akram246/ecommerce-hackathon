...
const Categories = () => {
  return (
    ...
    <div className='bg-black h-2000px] '>
      ...
      {/* Food Category Title */}
      <p className={`${VibeFont.className} text-[#FF9F0D] md:ml-[630px] leading-[40px] md:w-[177px] font-normal text-[32px] md:h-[40px]  ml-[10px]`}>
        Food Category
      </p>
      ...
      <div className="flex ml-[35px] flex-col md:flex-row text-white gap-[30px] md:ml-[100px] ">
        ...
        <div className="relative">
          <Image src="/food1.png" width={305} height={328} alt="" />
        ...
        {/* Food 2 Image */}
        <div><Image src='/food2.png' width={305} height={328} alt=""/></div>

        {/* Food 3 Image */}
        <div><Image src='/food3.png' width={305} height={328} alt=""/></div>

        {/* Food 4 Image */}
        <div><Image src='/food4.png' width={305} height={328} alt=""/></div>
      </div>
      ...
      <div className="w-full bg-cover bg-center relative flex flex-col  md:ml-[100px] justify-cter it-center md:flex-row text-white md:mt-[120px]"  style={{ backgroundImage: "url('assets/background.svg')" }}>
        ...
        <div>
          <div className="flex md:mr-[100px] flex-col gap-3">
            <div className="flex flex-col md:flex-row gap-1">
              <div><Image src='/shawarma.png' alt="" width={362} height={356} className="p-[20px]"/></div>
              <div><Image src='/food2.png' alt="" width={281} height={231} className="md:mt-[120px]"/></div>
            </div>
            <div className="flex flex-col md:flex-row gap-3">
              <div><Image src='/wings.png' width={244} height={306} alt="burger" className="md:w-[224px] w-[210px] md:ml-0 ml-[110px]"/></div>
              <div><Image src='/burger.png' alt="" width={221} height={226} className="md:w-[221px] w-[200px] md:ml-0 ml-[30px]"/></div>
              <div className="flex flex-col gap-3">
                <div><Image src='/meal.png' alt="" width={161} height={168} className="md:ml-0 ml-[170px]"/></div>
                <div><Image src='/salad.png' alt="" width={161} height={168} className="md:ml-0 ml-[20px]"/></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:mt-[70px]">
          ...
          <div className="relative w-[374px] md:ml-0 ml-4 h-[92px]">
            <Image src="/image.png" alt="rectangle" width={374} height={92} className="border-l-8 border-[#FF9F0D] md:w-[374px] w-[350px] rounded-2xl" />
      ...
      <div className="text-white flex flex-col md:flex-row md:m-[80px] md:mt-[160px]">
        <div className="flex flex-col">
          <div className="md:ml-[135px] ml-[140px] md:mt-0 mt-[20px]">
            <Image src='/image1.png' alt="" height={120} width={120} />
          </div>
        ...
        <div className="flex flex-col">
          <div className="md:ml-[135px] ml-[140px]">
            <Image src='/image2.png' alt="" height={120} width={120} />
          </div>
          <p className="md:w-[218px] md:h-[32px] font-bold text-[24px] leading-[32px] text-[#FFFFFF] md:ml-[100px] ml-[89px] my-6">Items Of Food</p>
        ...
        <div className="flex flex-col">
          <div className="md:ml-[135px] ml-[140px]">
            <Image src='/image3.png' alt="" height={120} width={120} />
          </div>
          <p className="md:w-[218px] md:h-[32px] font-bold text-[24px] leading-[32px] text-[#FFFFFF] md:ml-[100px] ml-[89px] my-6">Years Of Experienced</p>
          <p className="md:w-[67px] md:h-[48px] font-bold text-[40px] leading-[48px] text-[#FFFFFF] md:ml-[165px] ml-[163px] md:my-0 my-6">30+</p>
        </div>

        <div className="flex flex-col ">
          <div className="md:ml-[135px] ml-[140px]">
            <Image src='/image4.png' alt="" height={120} width={120} />
          </div>
          <p className="md:w-[218px] md:h-[32px] font-bold text-[24px] leading-[32px] text-[#FFFFFF] md:ml-[100px] ml-[89px] my-6">Happy Customers</p>
