...
const Footer = () => {
  return (
    <footer className="bg-black text-white  w-full">
      ...
      <div className="flex md:mt-[10px] flex-col md:flex-row justify-between items-center bg-black px-10 md:px-[135px] py-8 md:py-[50px]">
      ...
      <div className="max-w-screen-xl mx-auto py-8 md:py-12 px-6 md:px-[135px] grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 mt-[0.98]">
            {[1, 2, 3].map((_, index) => (
              <li key={index} className="flex gap-4">
                <Image src="/footer1.png" alt="Post" width={59.92} height={48.22} />
                <div>
